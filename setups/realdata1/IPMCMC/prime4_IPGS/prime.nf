...
cache true
  input:
    ...
    val snapshotPath from '/project/6028761/shijia57/rejfreeAnalysis'
...
cache true
  input:
    ...
    val snapshotPath from '/project/6028761/shijia57/phyloPMCMC'
...
echo true
  ...
  cpus 2
  executor 'slurm'
  clusterOptions  '--account=def-lelliott'

  input:
    file code
    
    each mainRand from  161..170
    each rand from  13199
    each particle from 2500
...
java   -cp 'code/lib/*' -Xmx8G   phyloPMCMC.PGSExperiments -useDataGenerator false    -nThousandIters 1 \
     -dataFile /project/6028761/shijia57/phyloPMCMC/Realdata/mtprim9.phy.alter.msf  \
     -refTree /project/6028761/shijia57/phyloPMCMC/Realdata/consensus_mtprim9.phy.alter.newick  \
     -nTax 20  \
     -treeRate 10\
     -mainRand $mainRand  \
     -len  1000 \
