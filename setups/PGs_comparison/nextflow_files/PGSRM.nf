...
cache true
  input:
    ...
    val snapshotPath from '/home/shijia57/source/phyloPMCMC'
...
echo true
  ...
  input:
    ...
    each particle from (200, 500, 1000)
    each iterScalings from 4000
    echo true
...
java   -cp 'code/lib/*' -Xmx4G   phyloPMCMC.PGSExperiments -useDataGenerator true    -nThousandIters 1 \
     -nTax 15  \
     -treeRate 10\
     -mainRand $mainRand  \
     -len  500 \
